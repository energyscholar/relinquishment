...
def fix_html_toc(html_path):
    ...
    title_pattern = (
        ...
        r'(?:<p><span><em>(?:and |The physics|Real people).*?</em></span></p>\s*)*'
...
<svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 420 280" style="display:block;margin:0 auto;">
  ...
  <defs>
    <style>@media(prefers-reduced-motion:reduce){animate{display:none}}</style>
    <linearGradient id="jup-bow-grad" x1="0%" y1="0%" x2="100%" y2="0%">
      <stop offset="0%" stop-color="#ff6b35" stop-opacity="0.6"/>
      <stop offset="100%" stop-color="#ff6b35" stop-opacity="0"/>
    </linearGradient>
    <linearGradient id="jup-tail-grad" x1="0%" y1="0%" x2="100%" y2="0%">
      <stop offset="0%" stop-color="#1a2d4a" stop-opacity="0.15"/>
      <stop offset="100%" stop-color="#1a2d4a" stop-opacity="0.02"/>
    </linearGradient>
  </defs>
  <!-- Solar wind (decorative, animated) -->
  <line x1="10" y1="100" x2="65" y2="118" stroke="#ffaa44" stroke-width="1.5" stroke-dasharray="6,4"><animate attributeName="stroke-dashoffset" from="10" to="0" dur="2s" repeatCount="indefinite"/></line>
  <line x1="10" y1="135" x2="65" y2="140" stroke="#ffaa44" stroke-width="1.5" stroke-dasharray="6,4"><animate attributeName="stroke-dashoffset" from="10" to="0" dur="2s" repeatCount="indefinite"/></line>
  <line x1="10" y1="170" x2="65" y2="162" stroke="#ffaa44" stroke-width="1.5" stroke-dasharray="6,4"><animate attributeName="stroke-dashoffset" from="10" to="0" dur="2s" repeatCount="indefinite"/></line>
  <line x1="10" y1="200" x2="65" y2="182" stroke="#ffaa44" stroke-width="1.5" stroke-dasharray="6,4"><animate attributeName="stroke-dashoffset" from="10" to="0" dur="2s" repeatCount="indefinite"/></line>
  ...
  <g data-hover="Magnetotail" data-hover-html="&lt;strong&gt;Magnetotail&lt;/strong&gt;&lt;br&gt;Stretches nearly a billion kilometers — almost to Saturn&#39;s orbit. The longest coherent magnetic structure in the solar system." style="cursor:pointer">
    ...
    <path d="M 195,195 Q 250,185 320,190" fill="none" stroke="#3a5f7a" stroke-width="1" opacity="0.4"/>
    <line x1="215" y1="140" x2="415" y2="140" stroke="#cd7f32" stroke-width="2" opacity="0.6"/>
    <line x1="215" y1="140" x2="415" y2="140" stroke="#cd7f32" stroke-width="6" opacity="0.08"/>
  ...
  <g data-hover="Aurora" data-hover-html="&lt;strong&gt;Aurora&lt;/strong&gt;&lt;br&gt;About 100 terawatts per hemisphere — 10,000 to 100,000 times more powerful than Earth&#39;s. Driven by rotation, not by the solar wind. Visible in ultraviolet from Earth orbit." style="cursor:pointer">
    ...
    <path d="M 168,162 Q 177,172 172,183" fill="none" stroke="#b19cd9" stroke-width="2" opacity="0.7"/>
  ...
  <g data-hover="Jupiter" data-hover-html="&lt;strong&gt;Jupiter&lt;/strong&gt;&lt;br&gt;Fourteen times Earth&#39;s surface field and 18,000 times the magnetic moment. Unlike Earth, Jupiter&#39;s magnetosphere is powered by its own rotation — the planet spins so fast it flings plasma outward like a centrifuge." style="cursor:pointer">
    ...
    <path d="M 136,135 Q 160,130 184,135" fill="none" stroke="#d4a574" stroke-width="0.8" opacity="0.4"/>
    <path d="M 137,142 Q 160,147 183,142" fill="none" stroke="#d4a574" stroke-width="0.8" opacity="0.4"/>
  ...
  <g data-hover="Io" data-hover-html="&lt;strong&gt;Io&lt;/strong&gt;&lt;br&gt;The most volcanically active body in the solar system. Tidal forces from Jupiter squeeze roughly one ton of material per second from its surface into space." style="cursor:pointer">
    ...
    <line x1="127" y1="102" x2="129" y2="96" stroke="#ff6b35" stroke-width="0.8" opacity="0.5"/>
  ...
  <g data-hover="Ganymede Mini-Magnetosphere" data-hover-html="&lt;strong&gt;Ganymede Mini-Magnetosphere&lt;/strong&gt;&lt;br&gt;The only moon in the solar system with its own magnetic field. A complete magnetosphere nested inside Jupiter&#39;s — auroral ovals and all. Discovered by Galileo in 1996." style="cursor:pointer">
    ...
    <path d="M 236,202 Q 240,205 244,202" fill="none" stroke="#5ba3cf" stroke-width="0.7" opacity="0.4"/>
    <text x="253" y="188" font-family="Georgia, serif" font-size="7" fill="#555" font-style="italic">Ganymede</text>
  </g>
</svg>
<figcaption style="font-size:0.75em;color:#888;margin-top:0.3em;font-style:italic;">Hover to explore</figcaption>
</figure>'''
...
<svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 420 280" style="display:block;margin:0 auto;">
  ...
  <defs>
    <style>@media(prefers-reduced-motion:reduce){animate{display:none}}</style>
    <linearGradient id="sat-bow-grad" x1="0%" y1="0%" x2="100%" y2="0%">
      <stop offset="0%" stop-color="#ff6b35" stop-opacity="0.6"/>
      <stop offset="100%" stop-color="#ff6b35" stop-opacity="0"/>
    </linearGradient>
    <linearGradient id="sat-tail-grad" x1="0%" y1="0%" x2="100%" y2="0%">
      <stop offset="0%" stop-color="#1a2d4a" stop-opacity="0.12"/>
      <stop offset="100%" stop-color="#1a2d4a" stop-opacity="0.02"/>
    </linearGradient>
  </defs>
  <!-- Solar wind (decorative, animated) -->
  <line x1="10" y1="105" x2="60" y2="118" stroke="#ffaa44" stroke-width="1.5" stroke-dasharray="6,4"><animate attributeName="stroke-dashoffset" from="10" to="0" dur="2s" repeatCount="indefinite"/></line>
  <line x1="10" y1="135" x2="60" y2="140" stroke="#ffaa44" stroke-width="1.5" stroke-dasharray="6,4"><animate attributeName="stroke-dashoffset" from="10" to="0" dur="2s" repeatCount="indefinite"/></line>
  <line x1="10" y1="165" x2="60" y2="158" stroke="#ffaa44" stroke-width="1.5" stroke-dasharray="6,4"><animate attributeName="stroke-dashoffset" from="10" to="0" dur="2s" repeatCount="indefinite"/></line>
  <line x1="10" y1="192" x2="60" y2="180" stroke="#ffaa44" stroke-width="1.5" stroke-dasharray="6,4"><animate attributeName="stroke-dashoffset" from="10" to="0" dur="2s" repeatCount="indefinite"/></line>
  <!-- Disc-shaped magnetotail (decorative background — flatter than Earth) -->
  <path d="M 200,115 L 415,105 L 415,130 L 220,132 Z" fill="url(#sat-tail-grad)" stroke="none"/>
  <path d="M 200,165 L 415,175 L 415,150 L 220,148 Z" fill="url(#sat-tail-grad)" stroke="none"/>
  ...
  <g data-hover="Ring System" data-hover-html="&lt;strong&gt;Ring System&lt;/strong&gt;&lt;br&gt;Saturn&#39;s rings absorb charged particles passing through, creating sharp gaps in the radiation belts. The rings act as a particle shield — a natural experiment in plasma-matter interaction." style="cursor:pointer">
    ...
    <line x1="184" y1="140" x2="215" y2="140" stroke="#dcc9a3" stroke-width="1.5" opacity="0.35"/>
  ...
  <g data-hover="Enceladus" data-hover-html="&lt;strong&gt;Enceladus&lt;/strong&gt;&lt;br&gt;A small ice moon with a subsurface ocean. Cracks near the south pole jet up to 1,000 kilograms per second of water vapor and ice particles into space — the primary plasma source for Saturn&#39;s magnetosphere." style="cursor:pointer">
    ...
    <line x1="205" y1="113" x2="205" y2="103" stroke="#a8c0d4" stroke-width="0.8" opacity="0.5"><animate attributeName="opacity" values="0.6;0.2;0.6" dur="3s" begin="1s" repeatCount="indefinite"/></line>
    <line x1="207" y1="113" x2="210" y2="104" stroke="#a8c0d4" stroke-width="0.8" opacity="0.5"><animate attributeName="opacity" values="0.6;0.2;0.6" dur="3s" begin="2s" repeatCount="indefinite"/></line>
    <text x="205" y="98" text-anchor="middle" font-family="Georgia, serif" font-size="7" fill="#555" font-style="italic">Enceladus</text>
  </g>
</svg>
<figcaption style="font-size:0.75em;color:#888;margin-top:0.3em;font-style:italic;">Hover to explore</figcaption>
</figure>'''
    ...
    diagrams = [
        ...
        ('Five hundred million kilometers away', JUPITER_MS_SVG, 'Jupiter MS'),
        ("Saturn’s magnetosphere is smaller", SATURN_MS_SVG, 'Saturn MS'),
    ]
...
<div class="ms-anim-container" id="mso-container" tabindex="0" role="group" aria-label="Animated magnetosphere visualization">
  <svg id="mso-svg" viewBox="0 0 1600 900" preserveAspectRatio="xMidYMid slice" role="img" aria-label="Animated: solar wind approaching Earth&#39;s magnetosphere" xmlns="http://www.w3.org/2000/svg">
    ...
    <g id="mso-sun-group">
      ...
      <g id="mso-streamers" opacity="0.35">
        ...
        <line x1="200" y1="450" x2="400" y2="260" stroke="#ffcc44" stroke-width="0.8" opacity="0.15"/>
        <line x1="200" y1="450" x2="400" y2="640" stroke="#ffcc44" stroke-width="0.8" opacity="0.15"/>
      </g>
    </g>
    ...
    <g id="mso-front-ms" opacity="0">
      <circle id="mso-front-shield" cx="1400" cy="450" r="130" fill="url(#mso-front-grad)" stroke="rgba(74,158,255,0.3)" stroke-width="1.5"/>
      <circle id="mso-front-bowshock" cx="1400" cy="450" r="175" fill="none" stroke="rgba(85,51,0,0.2)" stroke-width="1" stroke-dasharray="4,4"/>
    </g>
    ...
    <g id="mso-substorm" opacity="0">
      <ellipse id="mso-nenl" cx="1540" cy="450" rx="10" ry="4" fill="#ff6644" opacity="0" filter="url(#mso-glow)"/>
      <g id="mso-flow-particles"></g>
      <ellipse id="mso-aurora-n" cx="1410" cy="434" rx="10" ry="4" fill="#66ff88" opacity="0" filter="url(#mso-glow)"/>
      <ellipse id="mso-aurora-s" cx="1410" cy="466" rx="10" ry="4" fill="#66ff88" opacity="0" filter="url(#mso-glow)"/>
      <text id="mso-aurora-label" x="1440" y="425" fill="#66ff88" font-size="9" font-family="system-ui" opacity="0">Aurora</text>
      <text id="mso-phase-label" x="1450" y="185" fill="#aaa" font-size="13" font-family="system-ui" text-anchor="middle" opacity="0"></text>
      <text id="mso-substorm-label" x="1400" y="500" fill="#ff6644" font-size="16" font-family="system-ui" font-weight="bold" text-anchor="middle" opacity="0">Substorm</text>
      <text id="mso-energy-note" x="1550" y="435" fill="#ffaa44" font-size="15" font-family="system-ui" text-anchor="middle" opacity="0">Energy accumulates in the plasma sheet...</text>
      <text id="mso-discharge-note" x="1450" y="510" fill="#ff6644" font-size="15" font-family="system-ui" text-anchor="middle" opacity="0">...until it discharges as a substorm</text>
    </g>
  ...
  <div class="mso-key" id="mso-key">
    <div id="mso-time-text" style="margin-bottom:4px;"></div>
...
function catmullRom(pts,t){
  var n=pts.length-1,f=t*n,idx=Math.min(Math.floor(f),n-1),u=f-idx;
  var p0=pts[Math.max(0,idx-1)],p1=pts[idx],p2=pts[Math.min(n,idx+1)],p3=pts[Math.min(n,idx+2)];
  var u2=u*u,u3=u2*u;
  return [
    0.5*((-p0[0]+3*p1[0]-3*p2[0]+p3[0])*u3+(2*p0[0]-5*p1[0]+4*p2[0]-p3[0])*u2+(-p0[0]+p2[0])*u+2*p1[0]),
    0.5*((-p0[1]+3*p1[1]-3*p2[1]+p3[1])*u3+(2*p0[1]-5*p1[1]+4*p2[1]-p3[1])*u2+(-p0[1]+p2[1])*u+2*p1[1])
  ];
}
...
var DURATION=48000;
var POSTER_VB='1000 160 900 506';
var windG=document.getElementById('mso-wind-particles');
var windParts=[];
for(var i=0;i<80;i++){
  var isElectron=i>=50;
  var r=isElectron?(0.6+Math.random()*0.4):(1.4+Math.random()*0.6);
  var el=svgEl('circle',{r:r.toFixed(1),fill:isElectron?'#aaccff':'#ffb347',opacity:isElectron?'0.4':'0.5'},windG);
  var wy=200+Math.random()*500;
  windParts.push({el:el,x:SX+80+Math.random()*1100,y:wy,vx:isElectron?(1.8+Math.random()*1.0):(1.2+Math.random()*0.8),baseY:wy,isElectron:isElectron});
}
...
var psHalf=1.5,psLen=45;
document.getElementById('mso-ps').setAttribute('d','M'+(EX+8*MS_SCALE)+','+(EY-psHalf*MS_SCALE)+' L'+(EX+psLen*MS_SCALE)+','+(EY-psHalf*MS_SCALE*1.3)+' M'+(EX+8*MS_SCALE)+','+(EY+psHalf*MS_SCALE)+' L'+(EX+psLen*MS_SCALE)+','+(EY+psHalf*MS_SCALE*1.3));
var flG=document.getElementById('mso-fieldlines');
var fieldLs=[3,5,7,9];
for(var fi=0;fi<fieldLs.length;fi++){svgEl('path',{d:ptsToPath(dipoleLine(fieldLs[fi],40),EX,EY,MS_SCALE),fill:'none',stroke:'rgba(102,255,136,0.3)','stroke-width':'1'},flG);}
...
var frontWindEls=[];
for(var i=0;i<30;i++){frontWindEls.push({el:svgEl('circle',{r:'1.5',fill:'#ffb347',opacity:'0'},windG),x:EX-250+Math.random()*100,y:EY-200+Math.random()*400,vx:1.0+Math.random()*0.5});}
var heroG=svgEl('g',{id:'mso-hero-particles'},windG.parentNode);
var HERO_COUNT=6;
var heroParticles=[];
for(var i=0;i<HERO_COUNT;i++){
  var hel=svgEl('circle',{r:'4',fill:'#ffcc55',opacity:'0',filter:'url(#mso-glow)'},heroG);
  var laneY=EY+(i-2.5)*70;
  heroParticles.push({el:hel,startX:EX-400,laneY:laneY,x:EX-400-i*80,y:laneY,phase:'approach',arcAngle:0,speed:1.8+i*0.15});
}
var flowG=document.getElementById('mso-flow-particles');
var flowParts=[];
for(var i=0;i<10;i++){
  var fel=svgEl('circle',{r:'3',fill:'#ff8844',opacity:'0',filter:'url(#mso-glow)'},flowG);
  flowParts.push({el:fel,startX:EX+20*MS_SCALE,endX:EX+5*MS_SCALE,y:EY+(i-4.5)*5,x:EX+20*MS_SCALE,delay:0.38+i*0.015,seed:i*2.7});
}
var KF=[
  [0.00,    0,     0, 1600,  900],
  [0.06,    0,     0, 1600,  900],
...
function interpKF(t){
  ...
  var u2=u*u,u3=u2*u;
  var i0=Math.max(0,idx-1),i1=idx,i2=Math.min(n-1,idx+1),i3=Math.min(n-1,idx+2);
  var res=[];
...
var running=false,animStart=null,pausedElapsed=0,openDone=false;
var substormStart=0,substormCycleCount=0,lastSubstormPh=0;
var SUBSTORM_CYCLE=22000;
function resetState(){
  ...
  document.getElementById('mso-ms-labels').setAttribute('opacity','0.8');
  ...
  substormStart=0;substormCycleCount=0;lastSubstormPh=0;openDone=false;
  ...
  for(var i=0;i<narrations.length;i++){var nel=document.getElementById(narrations[i][2]);if(nel)nel.style.opacity='0';}
  document.getElementById('mso-time-text').textContent='';
  document.getElementById('mso-scale-text').textContent='150 million km';
...
function msUpdate(ts){
  ...
  progressBar.style.width=(t*68.57).toFixed(1)+'%';
  ...
  var zoom=1600/vw;
  for(var ni=0;ni<narrations.length;ni++){
    var ns=narrations[ni][0],ne=narrations[ni][1],nid=narrations[ni][2];
    var nel=document.getElementById(nid);
    if(t>=ns&&t<=ne){var fadeIn=clamp((t-ns)/0.02,0,1);var fadeOut=clamp((ne-t)/0.02,0,1);nel.style.opacity=Math.min(fadeIn,fadeOut).toFixed(2);}
  ...
  var sunInView=vx<SX+200;
  var sunGroupOp=sunInView?1:clamp(1-(vx-SX-200)/200,0,1);
  document.getElementById('mso-sun-group').setAttribute('opacity',sunGroupOp.toFixed(2));
  var sunLblPulse=Math.pow(Math.max(0,Math.sin(ts*0.0008)),4);
  var sunLblBase=(t<0.20)?clamp((t-0.02)/0.03,0,1)*clamp((0.20-t)/0.03,0,1):0;
  var sunLblOp=Math.max(sunLblBase,sunLblPulse*0.5)*sunGroupOp;
  document.getElementById('mso-sun-label').setAttribute('opacity',sunLblOp.toFixed(2));
  var frontOp=(t>0.37&&t<0.58)?Math.min(clamp((t-0.37)/0.04,0,1),clamp((0.58-t)/0.04,0,1)):0;
  document.getElementById('mso-front-ms').setAttribute('opacity',frontOp.toFixed(2));
  if(frontOp>0.1){
    for(var fi=0;fi<frontWindEls.length;fi++){var fw=frontWindEls[fi];fw.x+=fw.vx;var dx=fw.x-EX,dy=fw.y-EY,dist=Math.sqrt(dx*dx+dy*dy);if(dist<140){var angle=Math.atan2(dy,dx);fw.y+=Math.sin(angle)*2;fw.x-=0.5;}if(fw.x>EX+300||Math.abs(fw.y-EY)>350){fw.x=EX-250+Math.random()*50;fw.y=EY-200+Math.random()*400;}fw.el.setAttribute('cx',fw.x.toFixed(0));fw.el.setAttribute('cy',fw.y.toFixed(0));fw.el.setAttribute('opacity',(frontOp*0.5).toFixed(2));}
  }else{for(var fi=0;fi<frontWindEls.length;fi++)frontWindEls[fi].el.setAttribute('opacity','0');}
  var heroActive=t>0.37&&t<0.74;
  var heroFadeIn=clamp((t-0.37)/0.03,0,1);
  var heroFadeOut=clamp((0.74-t)/0.03,0,1);
  var heroOp=heroActive?Math.min(heroFadeIn,heroFadeOut):0;
  if(heroActive){
    var isFront=t<0.55;
    var shieldR=isFront?165:14.5*MS_SCALE;
    for(var hi=0;hi<heroParticles.length;hi++){var hp=heroParticles[hi];var hdx=hp.x-EX,hdy=hp.y-EY,hdist=Math.sqrt(hdx*hdx+hdy*hdy);
    ...
    for(var hi=0;hi<heroParticles.length;hi++){heroParticles[hi].el.setAttribute('opacity','0');if(t<0.35){heroParticles[hi].phase='approach';heroParticles[hi].x=EX-350-hi*80;heroParticles[hi].y=heroParticles[hi].laneY;}}
  }
  ...
  if(moonOp>0){var moonAngle=ts*0.0004,moonR=420;var mx=EX+moonR*Math.cos(moonAngle),my=EY+moonR*Math.sin(moonAngle);document.getElementById('mso-moon').setAttribute('cx',mx.toFixed(0));document.getElementById('mso-moon').setAttribute('cy',my.toFixed(0));}
  document.getElementById('mso-earth').setAttribute('opacity','1');
  var labelOp=sideOp*0.8;
  document.getElementById('mso-ms-labels').setAttribute('opacity',labelOp.toFixed(2));
  var pScale=vw/1600;
  ...
  var barSvgUnits=(svgRect.width>0)?80*(vw/svgRect.width):vw*0.05;
  var msKm=(barSvgUnits/MS_SCALE)*6371;
  var auKm=(barSvgUnits/1200)*1.496e8;
  var scaleKm;
  if(vw<=900)scaleKm=msKm;
  else if(vw>=1400)scaleKm=auKm;
  else{var blend=(vw-900)/500;scaleKm=msKm*(1-blend)+auKm*blend;}
  var scaleTxt;
  if(scaleKm>5e7)scaleTxt=(scaleKm/1.496e8).toFixed(1)+' AU';
  else if(scaleKm>1e6)scaleTxt=Math.round(scaleKm/1e6).toLocaleString()+'M km';
  else if(scaleKm>1e4)scaleTxt=Math.round(scaleKm/1e3).toLocaleString()+'k km';
  else scaleTxt=Math.round(scaleKm).toLocaleString()+' km';
  document.getElementById('mso-scale-text').textContent=scaleTxt;
  var TRK=[
    [0.00,16000],[0.22,24000],[0.34,800],[0.43,1200],
    [0.57,245],[0.67,245],[0.76,500000],[0.86,500000],
    [0.94,245],[1.00,245]
  ];
  var timeX=TRK[TRK.length-1][1];
  for(var ti=0;ti<TRK.length-1;ti++){
    if(t>=TRK[ti][0]&&t<=TRK[ti+1][0]){
      var f=(t-TRK[ti][0])/(TRK[ti+1][0]-TRK[ti][0]);
      var logA=Math.log(TRK[ti][1])/Math.LN10,logB=Math.log(TRK[ti+1][1])/Math.LN10;
      timeX=Math.pow(10,logA+(logB-logA)*f);
      break;
    }
  }
  var timeTxt;
  if(timeX>=1e6)timeTxt=(timeX/1e6).toFixed(1)+'M×';
  else if(timeX>=1e4)timeTxt=Math.round(timeX/1e3).toLocaleString()+'k×';
  else timeTxt=Math.round(timeX).toLocaleString()+'×';
  document.getElementById('mso-time-text').textContent='Time: '+timeTxt;
  var windLabelOp=(t>0.20&&t<0.42)?Math.min(clamp((t-0.22)/0.03,0,1),clamp((0.42-t)/0.03,0,1)):0;
  if(windLabelOp>0){document.getElementById('mso-wind-label').setAttribute('x','700');document.getElementById('mso-wind-label').setAttribute('y','410');}
  document.getElementById('mso-wind-label').setAttribute('opacity',(t>=0.57&&t<=0.67)?'0.3':windLabelOp.toFixed(2));
  if(moonOp>0){
    var inReveal=t>0.76&&t<0.90;
    var moonLabelOp=inReveal?0.9:Math.pow(Math.max(0,Math.sin(ts*0.0004*Math.PI*2)),8)*0.8;
    document.getElementById('mso-moon-label').setAttribute('opacity',moonLabelOp.toFixed(2));
    var mx2=parseFloat(document.getElementById('mso-moon').getAttribute('cx'));
    var my2=parseFloat(document.getElementById('mso-moon').getAttribute('cy'));
    document.getElementById('mso-moon-label').setAttribute('x',mx2.toFixed(0));
    document.getElementById('mso-moon-label').setAttribute('y',(my2-8).toFixed(0));
  }
  if(t>=1.0&&!openDone){openDone=true;playBtn.innerHTML='&#9654;';for(var i=0;i<heroParticles.length;i++)heroParticles[i].el.setAttribute('opacity','0');document.getElementById('mso-wind-label').setAttribute('opacity','0');}
  if(t<1.0&&running){requestAnimationFrame(msUpdate);}else if(openDone&&running){substormStart=0;requestAnimationFrame(substormLoop);}
}
function substormLoop(ts2){
  if(!running)return;
  if(!substormStart)substormStart=ts2;
  var elapsed=(ts2-substormStart)%SUBSTORM_CYCLE;
  var ph=elapsed/SUBSTORM_CYCLE;
  ...
  var ba=breathAmp*Math.sin(ts2*0.003);
  var tailLen=ph<0.36?50+20*(ph/0.36):ph<0.41?70:ph<0.55?70-20*((ph-0.41)/0.14):50;
  var mpB=boundaryPts(9.5+ba*0.5,0.5,60,tailLen);
  document.getElementById('mso-mp').setAttribute('d',ptsToPath(mpB,EX,EY,MS_SCALE));
  var bsB=boundaryPts(14+ba*0.3,0.6,60,tailLen+5);
  document.getElementById('mso-bs').setAttribute('d',ptsToPath(bsB,EX,EY,MS_SCALE));
  var psGap=ph<0.36?1.5-0.8*(ph/0.36):ph<0.55?0.7+0.8*((ph-0.36)/0.19):1.5;
  document.getElementById('mso-ps').setAttribute('d','M'+(EX+8*MS_SCALE)+','+(EY-psGap*MS_SCALE)+' L'+(EX+tailLen*MS_SCALE)+','+(EY-psGap*MS_SCALE*1.3)+' M'+(EX+8*MS_SCALE)+','+(EY+psGap*MS_SCALE)+' L'+(EX+tailLen*MS_SCALE)+','+(EY+psGap*MS_SCALE*1.3));
  var nenlOp=(ph>0.36&&ph<0.45)?Math.sin((ph-0.36)/0.09*Math.PI):0;
  document.getElementById('mso-nenl').setAttribute('opacity',nenlOp.toFixed(2));
  for(var fi=0;fi<flowParts.length;fi++){
    var fp=flowParts[fi];
    if(ph<0.36){
      var arriveT=fi*0.03;
      if(ph>arriveT){var loadP=(ph-arriveT)/(0.36-arriveT);fp.x=fp.startX-loadP*30;fp.el.setAttribute('cx',fp.x.toFixed(0));fp.el.setAttribute('cy',(fp.y+Math.sin(ts2*0.006+fp.seed)*2).toFixed(0));fp.el.setAttribute('opacity',(0.3+loadP*0.5).toFixed(2));fp.el.setAttribute('fill','#ff8844');}
      else{fp.el.setAttribute('opacity','0');}
    }else{
      var flowT=clamp((ph-fp.delay)/0.20,0,1);
      if(flowT>0&&flowT<1){fp.x=fp.startX+(fp.endX-fp.startX)*flowT;fp.el.setAttribute('cx',fp.x.toFixed(0));fp.el.setAttribute('cy',(fp.y+Math.sin(ts2*0.01+fp.seed)*3).toFixed(0));fp.el.setAttribute('opacity','0.8');fp.el.setAttribute('fill','#ffcc44');}
      else{fp.el.setAttribute('opacity','0');}
    }
  }
  var psGlow=ph<0.36?0.3+0.5*(ph/0.36):ph<0.55?0.8-0.4*((ph-0.36)/0.19):0.4;
  document.getElementById('mso-ps').setAttribute('stroke','rgba(255,136,68,'+psGlow.toFixed(2)+')');
  document.getElementById('mso-ps').setAttribute('stroke-width',(2+psGlow*3).toFixed(1));
  var auroraOp=(ph>0.52&&ph<0.82)?(ph<0.60?(ph-0.52)/0.08:ph<0.70?1.0:1.0-(ph-0.70)/0.12):0;
  document.getElementById('mso-aurora-n').setAttribute('opacity',(auroraOp*0.7).toFixed(2));
  document.getElementById('mso-aurora-s').setAttribute('opacity',(auroraOp*0.7).toFixed(2));
  document.getElementById('mso-aurora-n').setAttribute('rx',(8+6*auroraOp).toFixed(0));
  document.getElementById('mso-aurora-s').setAttribute('rx',(8+6*auroraOp).toFixed(0));
  document.getElementById('mso-aurora-label').setAttribute('opacity',(auroraOp*0.6).toFixed(2));
  var labelEl=document.getElementById('mso-phase-label');
  var pName=ph<0.36?'Growth':ph<0.41?'Onset':ph<0.55?'Expansion':ph<0.73?'Recovery':'Quiet';
  labelEl.textContent=pName;labelEl.setAttribute('opacity','0.6');
  var substormLblOp=ph>=0.41&&ph<0.55?clamp((ph-0.41)/0.04,0,0.9):ph>=0.55&&ph<0.65?0.9*clamp((0.65-ph)/0.10,0,1):0;
  document.getElementById('mso-substorm-label').setAttribute('opacity',substormLblOp.toFixed(2));
  var energyNoteOp=ph<0.30?clamp((ph-0.08)/0.06,0,0.8):ph<0.41?0.8*clamp((0.41-ph)/0.06,0,1):0;
  var dischargeNoteOp=ph>=0.41&&ph<0.55?clamp((ph-0.43)/0.04,0,0.8):ph>=0.55&&ph<0.65?0.8*clamp((0.65-ph)/0.06,0,1):0;
  document.getElementById('mso-energy-note').setAttribute('opacity',energyNoteOp.toFixed(2));
  document.getElementById('mso-discharge-note').setAttribute('opacity',dischargeNoteOp.toFixed(2));
  var ma=ts2*0.0004;
  var moonX=EX+420*Math.cos(ma),moonY=EY+420*Math.sin(ma);
  document.getElementById('mso-moon').setAttribute('cx',moonX.toFixed(0));document.getElementById('mso-moon').setAttribute('cy',moonY.toFixed(0));
  var moonLblPulse=Math.pow(Math.max(0,Math.sin(ma)),8);
  document.getElementById('mso-moon-label').setAttribute('opacity',(moonLblPulse*0.8).toFixed(2));
  document.getElementById('mso-moon-label').setAttribute('x',moonX.toFixed(0));document.getElementById('mso-moon-label').setAttribute('y',(moonY-8).toFixed(0));
  for(var wi=0;wi<windParts.length;wi++){
    var p=windParts[wi];p.x+=p.vx*(900/1600)*2.5;
    var wx=(p.x-EX)/MS_SCALE,wy=(EY-p.y)/MS_SCALE;
    var mpR=(9.5+ba*0.5)*Math.pow(2/(1+Math.max(Math.cos(Math.atan2(wy,-wx)),0.1)),0.5);
    if(Math.sqrt(wx*wx+wy*wy)<mpR+1.5&&wx<0){p.y+=(p.y<EY?-1.8:1.8);p.x-=0.5;}
    if(p.x>EX+400||p.y<100||p.y>800){p.x=1220;p.y=200+Math.random()*500;}
    p.el.setAttribute('cx',p.x.toFixed(0));p.el.setAttribute('cy',(p.baseY+Math.sin(p.x*0.008)*6).toFixed(0));
  }
  document.getElementById('mso-time-text').textContent='Time: 245×';
  document.getElementById('mso-scale-text').textContent='127k km';
  var windLbl=document.getElementById('mso-wind-label');
  windLbl.setAttribute('x','1030');windLbl.setAttribute('y','350');
  var windLblPulse=0.3+0.2*Math.sin(ts2*0.001);
  windLbl.setAttribute('opacity',windLblPulse.toFixed(2));
  requestAnimationFrame(substormLoop);
}
function msPlay(){if(running)return;running=true;container.classList.add('ms-playing');playBtn.innerHTML='&#9208;';playBtn.setAttribute('aria-pressed','true');document.getElementById('mso-poster-title').setAttribute('opacity','0');document.getElementById('mso-poster-wind').setAttribute('opacity','0');animStart=null;if(openDone){requestAnimationFrame(substormLoop);}else{requestAnimationFrame(msUpdate);}}
