...
(function() {
  ...
  (function() {
    ...
    styleEl.textContent =
      '@media (max-width: 900px) { #cover-magnetosphere { display: none !important; } }' +
    ...
    wrapper.style.cssText = 'position:absolute;bottom:100%;right:0;' +
      'width:350px;max-width:50%;pointer-events:none;z-index:1;opacity:0.85;';
    ...
    var darkSvg =
      ...
      '</defs>' +
      '<g opacity="0.7">' +
      '<circle cx="45" cy="22" r="0.8" fill="#fff" opacity="0.6"/>' +
      ...
      '<circle cx="540" cy="18" r="0.7" fill="#fff" opacity="0.6"/>' +
      ...
      '<circle cx="300" cy="38" r="1.0" fill="#fff" opacity="0.7" filter="url(#cv-star-glow)"/>' +
      '<circle cx="520" cy="60" r="0.9" fill="#fff" opacity="0.6" filter="url(#cv-star-glow)"/>' +
      '<circle cx="55" cy="265" r="1.0" fill="#fff" opacity="0.6" filter="url(#cv-star-glow)"/>' +
      '<circle cx="610" cy="280" r="0.8" fill="#fff" opacity="0.5" filter="url(#cv-star-glow)"/>' +
      ...
      '</g>' +
      '<g opacity="0.35">' +
      '<line x1="0" y1="128" x2="72" y2="140" stroke="#C4913B" stroke-width="0.8" stroke-linecap="round"/>' +
      '<line x1="0" y1="148" x2="78" y2="153" stroke="#C4913B" stroke-width="1.0" stroke-linecap="round"/>' +
      '<line x1="0" y1="160" x2="80" y2="160" stroke="#C4913B" stroke-width="1.2" stroke-linecap="round"/>' +
      '<line x1="0" y1="172" x2="78" y2="167" stroke="#C4913B" stroke-width="1.0" stroke-linecap="round"/>' +
      '<line x1="0" y1="192" x2="72" y2="180" stroke="#C4913B" stroke-width="0.8" stroke-linecap="round"/>' +
      '</g>' +
      '<g opacity="0.15">' +
      '<line x1="0" y1="110" x2="55" y2="125" stroke="#C4913B" stroke-width="0.5" stroke-linecap="round"/>' +
      '<line x1="0" y1="210" x2="55" y2="195" stroke="#C4913B" stroke-width="0.5" stroke-linecap="round"/>' +
      '</g>' +
      '<path d="M 100,45 C 72,90 68,130 72,160 C 68,190 72,230 100,275" fill="none" stroke="url(#cv-bow)" stroke-width="1.8" stroke-linecap="round"/>' +
      ...
      '<path d="M 157,140 C 140,125 130,132 125,152 C 130,172 140,185 157,178" stroke="#5dade2" stroke-width="1.0" opacity="0.55"/>' +
      '<path d="M 153,132 C 125,105 108,122 100,160 C 108,198 125,215 153,188" stroke="#5dade2" stroke-width="0.9" opacity="0.45"/>' +
      '<path d="M 148,122 C 112,82 90,115 84,160 C 90,205 112,238 148,198" stroke="#5dade2" stroke-width="0.7" opacity="0.3"/>' +
      '</g>' +
      '<g fill="none" stroke-linecap="round">' +
    ...
    var lightSvg =
      ...
      '<line x1="0" y1="210" x2="55" y2="195" stroke="#C4913B" stroke-width="0.5" stroke-linecap="round"/>' +
      '</g>' +
      '<path d="M 100,45 C 72,90 68,130 72,160 C 68,190 72,230 100,275" fill="none" stroke="url(#lm-bow)" stroke-width="1.8" stroke-linecap="round"/>' +
      ...
      '<g fill="none" stroke-linecap="round">' +
      '<path d="M 157,140 C 140,125 130,132 125,152 C 130,172 140,185 157,178" stroke="#1a5276" stroke-width="1.0" opacity="0.40"/>' +
      '<path d="M 153,132 C 125,105 108,122 100,160 C 108,198 125,215 153,188" stroke="#1a5276" stroke-width="0.9" opacity="0.30"/>' +
      '<path d="M 148,122 C 112,82 90,115 84,160 C 90,205 112,238 148,198" stroke="#1a5276" stroke-width="0.7" opacity="0.20"/>' +
      '</g>' +
      '<g fill="none" stroke-linecap="round">' +
  ...
  function updateBreadcrumb() {
    ...
    // URL reflects reading position — but preserve deep-link hashes
    // that point to elements inside the current chapter (puzzles, anchors, etc.)
