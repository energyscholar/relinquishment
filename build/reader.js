...
(function() {
  ...
  // --- Custodian-only filter (G button) ---
  ...
  gBtn.addEventListener('click', function() {
    showCustodianOnly = !showCustodianOnly;
    if (showCustodianOnly) {
  ...
  pdfLink.style.cssText = 'flex:0 0 auto;font-size:0.85em;opacity:0.7;' +
  ...
  (function() {
    ...
    wrapper.style.cssText = 'position:absolute;right:0;top:20px;' +
      'width:' + msWidth + 'px;' +
  ...
  // --- Custodian menu item click handler (Plan 0150) ---
  ...
  function activateCustodianMenuItem(item) {
