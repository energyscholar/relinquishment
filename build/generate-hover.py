...
lines.append("}")
lines.append("")
lines.append("% HTML-only hover: italic in PDF (no footnote), HOVERSTART marker for HTML")
lines.append("% Use for p3 chapter terms — technically trained readers don't need PDF footnotes")
lines.append("\\newcommand{\\hovertiphtml}[1]{%")
lines.append("  \\textit{#1}%")
lines.append("  \\ifcsdef{hover@#1}{\\csundef{hover@#1}}{}%")
lines.append("}")
lines.append("")
