Subject: Deadman's switch — please hold this PDF

Cory,

We've corresponded lightly since 2009. You once gave me permission to do a book-on-tape version of Little Brother.  I'm asking a favor I hope you never need to act on.

I'm sending you a PDF. You don't need to read it now, but you're welcome to. You don't need to do anything with it unless something happens to me. It's an incomplete but sufficient book.
...
- Please only publish it if I am permanently unable to do so

**What it is:**
A book I've been writing for 20 years about a classified program I learned about through guided deduction from a mentor (Australian SAS / DARPA, 2003-2006). Topological quantum neural networks predating public quantum computing by ~7 years. Three possibilities: confabulation, exaggerated kernel, or substantially true. I can't tell which. The reader decides.

The book is a working draft — complete in scope but  rough in places. I have a long list of improvements queued up and want to limit my exposure during the editing period. That's what this deadman switch is for. If you ever need to publish it, don't wait for a better version. Imperfect beats nonexistent.

**SHA-256 hash of the PDF:**
`b910618ace240f34b00709f18fedaec6165a69ce15f2cde4e972024a1641abbd`

This is a precaution, not a panic. I'll check in before 90 days have passed.

Thank you.

Bruce Stephenson
postquantum.substack.com
