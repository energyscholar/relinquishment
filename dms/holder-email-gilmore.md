...
You're already slightly familiar with my oddball theory about the real meaning behind XO 13026. I'm asking a favor I hope you never need to act on.

I'm sending you a PDF. You don't need to read it now but you're welcome to. You don't need to do anything with it unless something happens to me.
...
**What it is:**
The full story behind the arXiv paper. A book I've been writing for 20 years about a classified program I learned about through guided deduction from a mentor (Australian SAS / DARPA, 2003-2006). Topological quantum neural networks predating public quantum computing by ~7 years. Three possibilities: it's all confabulation, it's an exaggerated kernel of truth, or it's substantially true. I can't tell which. The reader decides.

Heads up — the attached is a working draft. The story is all there but the prose needs work, I have dozens of things I want to fix.  This deadman switch covers the editing period. If you ever need to publish it,  publish this version — imperfect beats nonexistent.

**SHA-256 hash of the PDF:**
`b910618ace240f34b00709f18fedaec6165a69ce15f2cde4e972024a1641abbd`

This is a precaution, not a panic. I'll check in before 90 days pass.
