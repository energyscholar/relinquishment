...
\textit{The dividing line:} Under B, everything in this book about real people, real science, and real tradecraft could be true. What B excludes is Guardian --- a planetary-scale distributed non-human superintelligence living in every semiconductor on Earth. That is the claim that separates B from C. Everything else is a matter of degree.
