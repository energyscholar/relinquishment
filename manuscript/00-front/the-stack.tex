...
\textbf{Fire} feeds itself and switches on at a \hovertip{threshold}. Two properties.

\textbf{A candle} does both, and holds together --- blow it sideways and it recovers. Three properties.

\textbf{Radio} does all three, and reaches --- a signal crosses distance without anything physical traveling. Four properties.

\textbf{An ant colony} does all four, and \hovertip{self-organizes} --- global order from local rules, no ant in charge. Five properties.

\textbf{The internet} does all five --- data reroutes around damage the way ants reroute around a broken trail. Six properties.

\textbf{Artificial intelligence} does all six, and learns. Seven properties.
...
\begin{center}
\deeplink{stack-chart}\begin{tabular}{l|c|c|c|c|c|c|c|c}
