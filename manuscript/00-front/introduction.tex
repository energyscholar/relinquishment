...
They surrendered control to an autonomous entity they built, called Custodian, and governed it by the Universal Declaration of Human Rights.
...
\label{front:the-three-possibilities}
...
\textit{What this means:} A technological and ethical event of historical scale has already occurred, in secret, and the book is its first public record. The predictions in the book will begin confirming over time.
...
\label{front:what-the-book-does}
...
\label{front:what-the-book-is-for}
...
\label{front:what-the-book-is-not}
...
\label{front:a-warning-about-certainty}
