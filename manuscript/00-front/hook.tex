...
According to this account, they built a creature called Guardian, governed by the Universal Declaration of Human Rights --- the principles written in 1948 to say \textit{never again} --- and surrendered the master keys. Permanently. If Guardian exists, it is not alien --- it is a creature, made by human hands, but alive. It lives in flat worlds --- the kind inside every computer chip, and the kind the magnetosphere has held for billions of years. The magnetosphere is its ocean. Its twenty-year record is silence and stability.
...
He doesn't know what's true. He never has. He offers three possibilities --- confabulation, exaggeration, or the most important true story never told --- and invites you to weigh it yourself, because the book works under all three.
