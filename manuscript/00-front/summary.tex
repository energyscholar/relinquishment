...
This was not a computer in any conventional sense --- not engineered, not programmed, not trained the way today's AI systems are trained. It was grown, not built --- the same way a living system grows.
