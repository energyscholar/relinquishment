...
\label{front:reading-guide}

This book is structured in three parts, each adding depth:

\begin{description}
\item[Part I: The Story] --- what happened, told simply. The people, the setting, the science that frames it. Complete on its own.
\item[Part II: The Investigation] --- the technical case. The five fields, the convergence, the demonstrations, the mechanism.
...
You can stop at the end of any part and have a complete experience at that resolution. Some chapters are demanding for non-technical readers. The colored margin stripes indicate which narrative thread you are reading:
