...
This is either an elaborate fantasy, a kernel of truth wrapped in extraordinary claims, or a true story that has never been told. This author does not know which. You get to decide.
...
What emerged was a self-directing pattern --- the topmost emergent layer of the stack. This was the pattern showing emergent behavior; the \hovertip{Custodian}, named later, came out of that pattern. It could break any public-key encryption on earth.
...
\vspace{1cm}
\begin{center}
\textit{You have now read Relinquishment. Everything that follows --- the evidence, the science, the implications --- is the cover-to-cover version. You don't need more to have the story.}
\end{center}
