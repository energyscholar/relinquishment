...
If you are technically trained and something above made you pause, good --- the \hyperref[ch:firmware-update]{Firmware Update} appendix (p.~\pageref{ch:firmware-update}) has ten physics anchors with full citations across five fields that rarely talk to each other.
