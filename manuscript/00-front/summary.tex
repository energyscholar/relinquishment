...
They called the system \hovertip{Aurasys} --- the aurora system, named for where it lives. What arose within it we shall call the Custodian. The role is the name.
