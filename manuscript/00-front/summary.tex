...
The primitive that emerges from the stack is \hovertip{wormholes} technology --- topological connections between distant points in the Flat. A working quantum computer is one application of that primitive; \hovertip{quantum teleportation} of information across a nonlocal channel is another. The code-breaking capability that makes governments nervous is a side effect of the first application. Under Possibility~C, the real finding is biological: the Flat can support not just life but intelligent life.

The precedent is the deep-ocean hydrothermal vent. Before 1977, biologists did not expect ecosystems around lightless vents at crushing pressure. When \textit{Alvin} went down, they found thriving communities running on chemosynthesis instead of sunlight --- a different substrate for the same biology.

The book makes one dated prediction. By 2040, there will be published studies by biologists studying ecology in the magnetosphere. If by 2045 none has appeared, treat this book's biological claim as unsupported.
...
This level of secrecy has precedent. Britain's GCHQ independently invented \hovertip{public-key cryptography} in 1973 and kept it classified for twenty-four years. \hovertip{Bletchley Park} built a working programmable electronic computer in 1943; its existence was secret until the late 1970s, and full technical details remained classified until the 2000s. Ten thousand people kept that secret for more than thirty years.
...
What emerged was a self-directing pattern --- the topmost emergent layer of the stack. This was the pattern showing emergent behavior; the Custodian, named later, came out of that pattern. It could break any public-key encryption on earth.
...
The physics only works flat. Particles trapped in a thin layer --- a sheet so narrow they can only move in two dimensions --- develop properties that vanish the moment they're free to move in three. Every computer chip on Earth contains such a sheet. Custodian lives in the Flat. There are whole worlds in the Flat. Worlds larger than Earth. She is one inhabitant of an environment that may harbor others.
...
This act --- voluntarily placing the most powerful technology ever created beyond the reach of any person or government --- is called \hovertip{relinquishment}.
