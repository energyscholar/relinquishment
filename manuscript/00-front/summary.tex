...
The country that controlled this machine could read every other country's military plans, diplomatic cables, and intelligence reports. It could predict financial markets by reading private communications. It could identify and track every dissident, every journalist, every whistleblower. The physics explains why: moving information through the Flat requires a classical backchannel --- an ordinary signal through ordinary channels. That is a theorem, not an engineering limitation. But those backchannels already exist in every electronic device --- wires, radio links, timing signals. Under Possibility~C, the entity was already inside every device before anyone plugged it in.
