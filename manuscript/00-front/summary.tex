...
% Reordered Session 30 to echo 5-part book structure: Story → Reckoning → Implications → Science → Question
...
\item Michael Freedman, one of the scientists named in the story, did in fact move from pure mathematics to leading Microsoft's quantum computing research group (Station~Q), following exactly the career trajectory the story describes.
...
% SPIRAL-REPEAT: "Why the Future Doesn't Need Us" — key reference, also in pos07-the-departure.tex, pos22-why-give-it-up.tex, pos27-extension.tex, timeline.tex, abstracts.tex
...
\item Topological quantum computing will advance faster than competing approaches. Under~C, this is because topological protection is the correct engineering path. Under~A or~B, it may simply reflect the inherent advantages of topological error resistance, which are already well-understood theoretically.
...
This book is structured in five parts, each adding depth:

\begin{description}
\item[Part I: The Story] --- what happened, told simply. Complete on its own.
\item[Part II: The Reckoning] --- the ethical weight: why they did it, what it cost, what it means.
...
You can stop at the end of any part and have a complete experience at that resolution. Some parts are quite difficult for non-technical readers. The colored margin stripes indicate which narrative thread you are reading:

\begin{itemize}
\item \textcolor{trackone}{\rule{12pt}{12pt}} \textbf{The Scientist's Confession} --- the inside story
\item \textcolor{tracktwo}{\rule{12pt}{12pt}} \textbf{The Recruit's Testament} --- Bruce's first-person account
\item \textcolor{trackthree}{\rule{12pt}{12pt}} \textbf{The Machine's Awakening} --- Guardian's arc
\item \textcolor{trackconv}{\rule{12pt}{12pt}} \textbf{Convergence} --- where all three tracks meet
\item Chapters without a margin stripe are \textbf{Bridge} chapters --- context that connects the tracks.
\end{itemize}
