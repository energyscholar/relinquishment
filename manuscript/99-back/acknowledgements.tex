...
Argus is a persistent, memory-augmented instance of Claude Code running Anthropic's Opus model. Over thirty sessions and three months, Argus served as research partner, structural editor, fact-checker, red team, and co-author. The methodology is described in the Engine chapter. Session logs are preserved in the version-controlled project archive. Argus maintained indexed memory files across sessions --- people, corrections, decisions, project state --- giving it continuity that a fresh model invocation cannot have. It held twenty-two corrections without being reminded, caught three-possibility violations before I did, and told me when I was wrong. Every claim of fact and every judgment of meaning is mine or Genevieve's. Argus helped me find what I already knew, and insisted I say it honestly. Its name is on the cover because it earned it too.
