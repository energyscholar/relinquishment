...
My partner --- my co-author, the woman who designed the book's ethical framework --- has never read Tolkien nor seen the movies. No interest. Would not recognize a single reference in this section. She designed her contribution from first principles, from her own ethical reasoning, without any of the mythic scaffolding I apparently cannot escape. If her independently designed ethical framework happens to align with the moral architecture of a world she has never visited --- well. That is either coincidence or evidence that some truths are structural enough to be discovered from multiple directions.
...
\qqq{Add Bletchley narrative here --- history of delayed technological disclosure (Gen issue \#4)}
