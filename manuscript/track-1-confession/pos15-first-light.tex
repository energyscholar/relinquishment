...
Room-temperature quantum coherence is not speculative. The Awschalom group (2015, \textit{Science Advances})\footcite{klimov2015} entangled over 10,000 copies of two-qubit entangled states \textit{at room temperature} in commercial silicon carbide wafers. NV centers in diamond maintain coherence times up to milliseconds at room temperature. The mechanism differs from FQHE, but the principle --- quantum coherence at room temperature in commercial semiconductors --- is experimentally established and replicated.
