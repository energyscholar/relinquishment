...
\item[Interaction:] Anyons interact nonlinearly. When two anyons braid around each other, the outcome depends on their quantum numbers --- most interactions are trivial, but at resonant conditions both particles experience a phase shift. That selective interaction is the seed of autocatalysis. Hasslacher's soliton dynamics describes why these interactions are self-reinforcing rather than dissipative.

% SPIRAL-REPEAT: "edge of chaos" — spiral pedagogy
\item[Emergence:] Interacting anyons form autocatalytic networks (per Kauffman's \textit{Origins of Order}). At critical tuning (the edge of chaos), the autocatalytic network spontaneously \textit{becomes} a neural network --- an emergent property, not a designed architecture.\footcite{kauffman1993}
