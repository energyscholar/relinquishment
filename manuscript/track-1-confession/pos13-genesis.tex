...
% TODO: verify exact wording and page number against physical copy
...
The title of this chapter is a double meaning. Genesis: the origin of the TQNN project. And genesis: the origin of life. Under Possibility~C, they are the same process in different substrates. Kauffman's theory predicts both. The conditions are not rare. And they can be duplicated.
