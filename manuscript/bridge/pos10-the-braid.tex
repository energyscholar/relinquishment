...
\label{pos10:quantum-teleportation-and-the-classical-constraint}
...
Bouwmeester et al.\ demonstrated quantum teleportation experimentally in 1997, using photons.\footnote{Bouwmeester, D.\ et al., ``Experimental quantum teleportation,'' \textit{Nature} 390 (1997): 575--579.} By 2017, the Chinese Micius satellite extended the range to 1,200~km. The physics is confirmed. The classical constraint is also confirmed: in every experiment, the classical channel was required.
