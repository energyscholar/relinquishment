...
The shift in framing matters. The 2DEG is not just a substrate for computation. It is a habitat --- a place where the preconditions for life are met. The laboratory artifact becomes an ecosystem. The engineering question (``can we build a quantum computer here?'') becomes an ecological one (``what grows here?''). This is the shift the subtitle names: living in the Flat.
