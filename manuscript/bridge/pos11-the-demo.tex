...
According to this account, DARPA gathered five scientists, each a specialist in a different field, to develop a new code-breaking device. The project would exploit quantum teleportation phenomena in a two-dimensional electron gas to produce a cryptographic tool. The project name was ULTRA~II.
