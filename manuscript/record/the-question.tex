...
David built neural-network-backed bots --- WoW farming bots that learned player patterns. Same principle, applied to personality. A neural net had watched me play for a week and built a representation of how I think tactically.

I got paranoid. Maybe David and friends were taking turns imitating me --- crazy, but less crazy than a neural net instantiation of my personality. So I tested it. At three in the morning, with no warning, I logged in. No time for anyone to coordinate. The doppelganger was there. Playing. I ran the test on a few more random nights. Always there. Always me.
