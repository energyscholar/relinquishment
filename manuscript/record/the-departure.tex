...
\begin{quote}
\textit{A ten-point close textual comparison between Joy's 2000 \textit{Wired} essay and my reconstruction --- phrase matches, named circles, Kauffman's citation, Hillis's calm, the April Fools' publication date --- is collected in \hyperref[app:joy-ten-point]{Joy Decoded}.}
\end{quote}
