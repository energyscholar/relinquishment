...
\textit{What follows is a reconstruction of technical constraints and response architecture --- derived from physics and engineering principles rather than direct testimony. The classical backchannels are not observed; they are inferred from what any large-scale system must use. Physics bounds the claims; confirmation is not the point.}
...
\srcnote{staging/space-chapter-fragments.md (Classical Backchannels) | research/custodian-limits-rhetorical-strategy.md | 2026-03-15 | VLF/ELF, power grid harmonics, Schumann resonances, satellite comms — relocated from pos32}
