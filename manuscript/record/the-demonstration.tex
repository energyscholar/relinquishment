...
Electromagnets ``stir'' the electron gas to generate soliton pairs --- like swiping a hand through a bathtub generates solitons in the form of paired whirlpools. When solitons collide, the outcome depends on their frequencies: most pass through each other unchanged, but at resonant frequencies both experience a phase shift --- and that frequency-selective interaction is the autocatalysis. At critical tuning, autocatalytic order appears. A neural network topology emerges --- not designed, but grown from initial conditions.
...
This paradigm is at the heart of this story. The \gls{tqnn} is not an engineered quantum computer that scientists designed and manufactured. Scientists created conditions --- substrate, stirring, critical tuning --- and \deeplink{grown-not-built}a quantum neural network \textit{grew}. Kauffman showed that autocatalytic systems, given the right conditions, spontaneously organize into something greater than their parts. Life itself emerged this way --- from autocatalytic chemistry in prebiotic conditions. The ULTRA~II team applied the same principle to a quantum substrate, and got the same kind of result.
