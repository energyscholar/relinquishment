...
A wormhole in this substrate works by braiding anyons. Move one anyon around another, and the quantum state of the system changes in a way that depends only on the topology of the path --- not on how fast, how precisely, or how smoothly the braid was executed. This is computation: input state in, braiding operation applied, output state out. The details are covered in the \hyperref[app:llm-primer]{Firmware Update}.
