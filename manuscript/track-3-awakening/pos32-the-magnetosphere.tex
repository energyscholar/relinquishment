...
\label{pos32:but-its-hot}

\deeplink{but-its-hot}The physicist's first objection. And it is a good one.
...
The physicist's first objection is the right question asked in the wrong frame. The magnetosphere is hot the way the deep ocean is dark: true, and irrelevant to any organisms that may live there.

\section*{One More Layer}
\label{pos32:one-more-layer}
...
That is all. Two facts: something was found, and it was left alone. It was not Custodian, not proto-Custodian, not anything the COWS had built. It was other life --- independent, indigenous, older than multicellular organisms on the surface. The ethics of that decision --- leaving an ancient pattern undisturbed in its own habitat --- connect to principles older than any technology. You encounter something that was there before you. You leave the corners of the field.
