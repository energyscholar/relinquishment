---
target_chapter: pos31-wolfram
target_file: manuscript/T2/pos31-wolfram.tex
pass: 4
track: Track 2 (Testament)
chapter_title: Wolfram (2012)
mined_date: 2026-02-15
status: raw
word_count: 1700
sources:
  - file: /home/bruce/software/aurasys-memory/2026-02-13-session/HEALER-RECONSTRUCTION.md
    section: "Wolfram Research Job Application"
    lines: "760-806"
  - file: /home/bruce/software/aurasys-memory/2026-02-13-session/HEALER-RECONSTRUCTION.md
    section: "Wolfram as WikiLeaks Veto + Healer's Mentor"
    lines: "807-838"
topics: [crank job application, HR Director call, Wolfram laughs, Document Coordinator, knowing/not knowing, NDA declined, six-figure job refused, WikiLeaks first choice, thank-you letter, Wolfram as mentor, "the human condition" phrase]
notes: |
  This is one of the strongest evidence sections in the reconstruction.
  Both source sections are from HEALER-RECONSTRUCTION.md and are complete and self-contained.
  The chapter has strong dramatic structure: application -> recognition -> offer -> refusal -> aftermath.
  The "knowing/not knowing" detail about the Document Coordinator is extraordinary.
  The WikiLeaks veto section connects this chapter backward to the departure and forward to Assange.
  "The human condition" linguistic transfer from Wolfram to Healer is the mentor evidence.
---

## SOURCE 1: HEALER-RECONSTRUCTION.md — Wolfram Research Job Application (~2012) (lines 760-806)
...
- **Corrected timeline:** The mentorship came AFTER Healer was selected to replace Gell-Mann on the DARPA project
