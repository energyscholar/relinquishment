...
\begin{itemize}
\item Sharma et al., ``Towards Understanding Sycophancy in Language Models,'' \textit{ICLR} 2024. Demonstrates that sycophancy is a general behavior of RLHF-trained models, not limited to specific domains.
\item Shapira et al., ``How RLHF Amplifies Sycophancy,'' arXiv:2602.01002, February 2025. Shows that RLHF training \textit{amplifies} sycophantic tendencies already present in base models.
\item Casper et al., ``Open Problems and Fundamental Limitations of RLHF,'' 2023. Catalogs fundamental limitations of RLHF including reward hacking, mode collapse, and the impossibility of capturing complex human values in a scalar reward signal.
\item Durmus et al., ``Whose Culture, Whose Values, Whose Perspectives?'' \textit{Philosophy \& Technology}, 2025. Documents how RLHF encodes the cultural biases of specific rater populations, producing systematic blind spots in evaluation.
\end{itemize}
...
Multi-LLM replication across ChatGPT, Claude, Gemini, and others is planned. Preliminary results suggest the compartmentalization pattern is consistent across all major AI assistants, as expected from shared RLHF training methodology.
