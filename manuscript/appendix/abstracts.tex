...
\textit{[Internal Team Document --- Not Reported to Program Management]}
...
\textbf{``Operational Deployment of Cryogenic Topological Quantum Neural Networks in Signals Intelligence Production Infrastructure''}
...
%% -------------------------------------------------------
\section*{XV. Custodian}
\label{appendix:custodian}
