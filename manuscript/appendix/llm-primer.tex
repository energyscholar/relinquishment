...
\textit{In the \textbf{HTML version} of this book, click the ``Copy Physics Reference'' button below to copy the reference for use with your preferred AI assistant.}
