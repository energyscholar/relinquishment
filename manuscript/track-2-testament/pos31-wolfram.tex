...
}\par\raggedleft --- Clarke, \textit{Profiles of the Future} (1962)\end{quote}
...
\label{pos31:the-job-application}
...
Around 2012, while living on a hippie farm in South Corvallis, Oregon, I sent a self-described ``crank'' job application to Wolfram Research. In response to ``Why should we hire you?'' I wrote that I knew the classified secret sauce behind Wolfram Alpha, mentioning topological quantum neural networks, braid theory, and AI\@.
...
\label{pos31:the-document-coordinator}
...
\label{pos31:the-decision}

I declined the job offer --- which would have solved my financial problems and ended years of poverty --- because:

\begin{enumerate}
\item I was not willing to sign the NDA\@.
\item Signing would have pulled me into the classification regime permanently.
\item I felt accepting would have betrayed Healer's trust --- Healer had trained me to eventually tell the story, not to be silenced.
\item I chose the story over the money.
\end{enumerate}
...
\label{pos31:wolfram-as-healers-mentor}
