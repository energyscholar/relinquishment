...
Under Possibility~C, \hovertiphtml{non-abelian anyon}s were not proven real by direct laboratory observation. They are proven real by inference: the emergent system is responsive, it computes, it does things in the world. If the system works, its constituent parts must exist.
