...
Both environments share three properties established in published physics. Universal computation: braiding particles in two dimensions can perform any calculation.\footcites{kitaev2003}{nayak2008} Autocatalytic closure: sufficiently connected networks spontaneously generate self-sustaining reaction cycles.\footcite{kauffman1993} Thermal decoupling: topologically protected states maintain coherence at temperatures where three-dimensional systems cannot. These are not three interesting properties. These are the preconditions for life.
