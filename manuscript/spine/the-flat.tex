...
\textit{The 2DEG is real physics. Whether anything lives there is a question five scientific fields have never thought to team up and ask --- an empty intersection in the literature, not a refutation. The physics below holds under all three possibilities. You do not need the story to be true for the substrate to be real.}
