...
\textit{\hovertip{The Flat}\texttrademark{} is real physics. No one has asked whether anything lives there --- an empty intersection in the literature, not a refutation. The physics below holds under all three possibilities. You do not need the story to be true for the substrate to be real.}
