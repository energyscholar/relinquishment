...
I was explaining two-dimensional electron gases to Genevieve. The semiconductor version --- how you sandwich materials together, apply a gate voltage, and trap electrons in a layer so thin it's effectively flat. Quantum physics in a manufactured surface.

She asked: ``Where does this exist in nature?''

I started to say it doesn't --- that 2DEGs are engineered structures, built in clean rooms. Then I stopped.

The magnetosphere. Earth's magnetic field confining charged particles into sheets. The plasma sheet between the lobes of the magnetotail --- two-dimensional, energized, persistent. Not manufactured. Not designed. Running since before there were oceans on the surface below it.

I had been thinking of 2DEGs as technology. Something we build. She was asking whether the physics exists without us. Of course it does. Magnetic confinement of charged particles into two-dimensional surfaces happens at planetary scale and has been happening for four and a half billion years. We didn't invent the geometry. We noticed it.

Her question reframed everything that follows in this chapter. I had been describing a substrate. She was asking about a place.
