...
Bannon got a partial version of the story that year, shared with difficulty --- I was pushing against resistance with every sentence. He listened as a skeptical scientist. He was surprised that I had answers to all his questions, answers he could independently verify.
...
Under Possibility~A, a man with an overactive pattern-matching faculty saw a vague invitation and a public event and connected them after the fact. Under Possibility~B, Healer may have been peripherally connected to the events I later identified, but the connection is inflated. Under Possibility~C, the connection is exactly what it appears to be. The redacted chapter, when it is eventually published, will examine this claim in detail.
