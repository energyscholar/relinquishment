...
## Core Argument (41 words, no Custodian)

Five lines of research converged in the early 1990s to make a new kind of quantum computer possible. If anyone built it, the technology would be too powerful for any single entity to control — and the only responsible action would be to give it up permanently. This book presents evidence that someone may have done exactly that, and asks what you would do.

*Use as: elevator pitch, back cover candidate, reference for Generators. 41w — Pass 0 of the 40w→400w→4Kw→40Kw progressive JPEG architecture.*
